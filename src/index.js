...
const TRADING_ENABLED    = false; // Disabilitato — ordini eseguiti dall'executor locale Mac
...
// Se WALLET_BASE_OVERRIDE è impostato, usa quello come saldo iniziale
let walletBase = process.env.WALLET_BASE_OVERRIDE
  ? parseFloat(process.env.WALLET_BASE_OVERRIDE)
  : 1000; // aggiornato dal saldo reale
